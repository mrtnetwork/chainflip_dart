...
import 'package:example/services/electrum/request_completer.dart';

class SubstrateWebsocketService with SubstrateRPCService {
  SubstrateWebsocketService._(
    this.url,
  ...
  Future<Map<String, dynamic>> call(SubstrateRequestDetails params,
    ...
    try {
      ...
      add(StringUtils.encode(params.params));
